...
object BeiDims {
     ...
     * 来源 / 功能大图标卡。
     *
     * 2026-09-20 从 56dp 收到 44dp：网络主页要**一屏放下五个入口**（本地网络 / 云盘 /
     * NAS / WebDAV / DLNA）再加一行「已保存」，56dp 的图标会把卡片顶得太高、挤掉最后一行。
     * 收到 44dp 之后卡片高度降下来，正好一屏 —— 三米外照样看得清，因为**识别靠形状与文字**，
     * 不靠图标占多大地方。
     */
    val IconSourceCard = 44.dp
